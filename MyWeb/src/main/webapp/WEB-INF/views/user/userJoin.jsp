    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-9 col-sm-12 join-form">
                    ...
                    <form action="<c:url value='/user/join'/>" method="post" id="joinForm">
                        ...
                        <div class="form-group"><!--기본 폼그룹을 가져온다-->
                            ...
                            <input type="password" class="form-control" id="userPw" placeholder="비밀번호 (영 대/소문자, 숫자 조합 8~16자 이상)" name="userPw">
				...
				<input type="text" class="form-control phone2" id="userPhone2" placeholder="휴대폰번호를 입력하세요." name="userPhone2">                                
                            </div>
                        </div>
			<div class="form-group email-form">
			  <label for="email">이메일</label>
				  <div class="input-group">
					  <input type="text" class="form-control" id="userEmail1" placeholder="이메일" name="userEmail1">
		          ...
		          <div class="mail-check-box">
		          	...
		          	<span id="mail-check-warn"></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="addrZipNum" placeholder="우편번호" readonly name="addrZipNum">
                                <div class="input-group-addon">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="addrBasic" placeholder="기본주소" name="addrBasic">
                        </div>
                        <div class="form-group">
    	...
    	$(function() {
			...
			$('.mail-check-input').blur(function() {
				...
				if(inputCode === code) {
					...
					//포커싱이 발생됬을때 초기값을 사용자가 선택한 값으로 무조건 설정하는 방법. (select에서 readonly 대용)
			...
			/*
				아이디 중복 체크를 했는지의 여부 체크하기(아이디 입력창이 readonly인지 확인)
				비밀번호 확인란이 제대로 인식이 됐는지의 여부 확인.
				이름란이 공백이 아닌지를 확인.
				(이메일 인증, 주소는 필수값이 아니기 때문에 확인 안하겠습니다.)
				문제가 없다면 폼 데이터 submit으로 처리하세요.
			*/
			$('#joinBtn').click(function() {
				/*const userPw = $('#userPw').val(); //내 방식
