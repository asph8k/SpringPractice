...
public class BoardController {
	...
	@GetMapping("/content")
	public void content(@ModelAttribute("boardNo") int bId, Model model) {
		model.addAttribute("bId", service.getArticle(bId));
	}
	...
	@GetMapping("/modify")
	public void modify(@ModelAttribute("boardNo") int bId, Model model) {
