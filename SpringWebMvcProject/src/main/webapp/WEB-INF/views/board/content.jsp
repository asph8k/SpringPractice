  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form id="formObj" role="form" action="<c:url value='/board/delete'/>" method="post"><!-- 삭제는 무조건 post방식으로 해야한다. -->
	...
	*/
	...
	$(document).ready(function() {
		...
		$('#list-btn').click(function() {
			console.log('목록 버튼이 클릭됨!');
			location.href='/board/list?page=${s.page}&cpp=${s.cpp}&condition=${s.condition}&keyword=${s.keyword}';
		});
